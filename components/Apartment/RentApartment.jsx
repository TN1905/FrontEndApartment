...
const RentApartment = () => {
  const { user, wallet, setWallet,message,setMessage } = useContext(HouseContext);
  ...
  const handleRentByCurrentWallet = async () => {
    ...
    if (walletAdmin) {
      ...
      await createRentApartment(rentApartmentData)
        .then((data) => {
                              ...
                              createContract(
                                ...
                                .then(async (data) => {
                                  ...
                                  if (totalRented) {
                                    ...
                                    } else if (totalRented >= 500000000 && totalRented < 1000000000 && !platinum) {
                                      const messageData = {
                                        id: timenow,
                                        description:
                            ...
                            createContract(user.username, rentApartmentData.id)
                              .then(async (data) => {
                                ...
                                if (totalRented) {
                                  ...
                                  } else if (totalRented >= 200000000 && totalRented < 500000000 && !gold) {
                                    const messageData = {
                                      id: timenow,
                                      description:
                                        "Claim your Gold NFT to use Coupon for discount",
                                  ...
                                  } else if (totalRented >= 50000000 && totalRented < 200000000 && !silver) {
                                    const messageData = {
                                      id: timenow,
                                      description:
                                        "Claim your Silver NFT to use Coupon for discount",
                                  ...
                                  } else if (totalRented >= 20000000 && totalRented < 50000000 && !bronze) {
                                    const messageData = {
                                      id: timenow,
                                      description:
                                        "Claim your Bronze NFT to use Coupon for discount",
    ...
    <div className="max-w-4xl mx-auto p-6 sm:p-8 md:p-10">
      <form onSubmit={handleSubmit}>
        <div className="grid gap-8">
          <div>
            <h1 className="text-3xl font-bold">{t("rent_an_apartment")}</h1>
            <p className="text-muted-foreground">{t("fill_form_to_rent")}</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <div className="grid gap-2">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Month Rent</span>
