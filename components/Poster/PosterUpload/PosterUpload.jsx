...
import {updateApartment2} from "../../../api/apartments/updateApartment";

const PosterUpload = ({ loadLocationData, apartmentTypeData }) => {
  ...
  const handleUpdateApartment = async () => {
    ...
    updateApartment2(editApartment.id, apartmentData)
      .then((data) => {
  ...
  const validateForm = () => {
    ...
    if (!acreage || acreage <= 0)
      formErrors.acreage = "Acreage must be greater than 0.";
    if (!description) formErrors.description = "Description is required.";
    if (cityValue === "cityDefault") formErrors.city = "City is required.";
    if (districtValue === "districtDefault")
      formErrors.district = "District is required.";
    if (wardValue === "wardDefault") formErrors.ward = "Ward is required.";
    if (apartTypeId === "apartDefault")
      formErrors.apartmentType = "Apartment Type is required.";
    if (images.length < 4)
      formErrors.images = "At least 4 images are required.";
            ...
            <div className="grid gap-2">
              ...
              >
                ...
                {errors.apartmentType && (
                  <p className="text-sm text-red-500">{errors.apartmentType}</p>
                )}
              </Select>
            </div>
          </div>
              ...
              <CardContent className="p-6 flex flex-col items-center justify-center text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Now this apartment can be rented by users
                  </p>
                </div>
                <Button
