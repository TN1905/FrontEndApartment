export async function createRentApartment(rentapartment) {
  try {
    const response = await fetch(`http://localhost:8080/rest/rentapartments`, {
      method: "POST",
      body: JSON.stringify(rentapartment),
      headers: {
